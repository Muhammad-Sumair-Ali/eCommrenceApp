...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font dark:bg-gray-900 dark:text-white">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          ...
          <span className="ml-3 text-xl dark:text-blue-400 font-mono"><b>Muhammad Sumair</b> </span>
        </a>
        <p className="text-sm dark:text-gray-200 text-gray-700 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          ©2024 <b> <small>MSUMAIR</small> / ECommerce-Pk</b>
          <a
             href="https://github.com/Muhammad-Sumair-Ali"
            className="dark:text-gray-300 text-gray-800 ml-1"
